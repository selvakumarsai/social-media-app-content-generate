...
# --- Streamlit UI ---
with st.sidebar:
    openai_api_key = st.text_input("Enter OpenAI API Key:", type="password", key="openai_key_twitter")
    serper_api_key = st.text_input("Enter Serper API Key:", type="password", key="serper_key_twitter")
